  ...
  const heroSlides = [
    {
      ...
      subtitle: 'At Eminence, we are all about enhancing what is already there. Whether its through our premium bundles, custom wigs or installs, the goal is to help you feel beautiful and confident in your own way. Your Crown, Your Beauty, Your Moment', 
