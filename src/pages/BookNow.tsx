    ...
    <div className="min-h-screen bg-soft-black">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-muted-coral to-golden-yellow bg-clip-text text-transparent">
            Book Your Appointment
          </h1>
          <p className="text-xl text-warm-beige max-w-2xl mx-auto drop-shadow-lg">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center mb-12">
            <div className="flex items-center space-x-4">
              ...
              <div className={`w-16 h-1 ${currentStep >= 2 ? 'bg-muted-coral' : 'bg-gray-700'}`}></div>
              <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold ${
                currentStep >= 2 ? 'bg-muted-coral text-white' : 'bg-gray-700 text-gray-400'
              }`}>
                2
              </div>
              <div className={`w-16 h-1 ${currentStep >= 3 ? 'bg-muted-coral' : 'bg-gray-700'}`}></div>
              <div className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold ${
          ...
          {currentStep === 1 && (
            <div className="animate-fade-in">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-warm-beige mb-4 flex items-center justify-center">
                  <Calendar className="w-6 h-6 text-muted-coral mr-3" />
                  Select Category
                </h2>
                <p className="text-gray-300">Choose the type of service you're looking for</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {serviceCategories.map((category) => (
                  <button
                    ...
                    className="group relative overflow-hidden rounded-xl p-6 bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 hover:border-muted-coral transition-all duration-300 hover:scale-105 text-left"
                  >
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="bg-golden-yellow text-soft-black px-3 py-1 rounded-full text-sm font-semibold">
                          SELECT
                        </div>
                      </div>
                      
                      <h3 className="text-xl font-semibold text-warm-beige mb-2 group-hover:text-muted-coral transition-colors">
                        {category.name}
                      </h3>
          ...
          {currentStep === 2 && selectedCategory && (
            <div className="animate-fade-in">
              <div className="flex items-center mb-8">
                ...
                >
                  <ArrowLeft className="w-5 h-5 text-warm-beige" />
                </button>
                <div>
                  <h2 className="text-2xl font-bold text-warm-beige mb-2 flex items-center">
                    <Calendar className="w-6 h-6 text-muted-coral mr-3" />
                    Select Appointment
                  </h2>
                  <p className="text-muted-coral font-medium">
              ...
              <div className="space-y-6">
                {services[selectedCategory as keyof typeof services]?.map((service) => (
                  <button
                    ...
                    className="group w-full text-left p-6 bg-gray-800 bg-opacity-50 backdrop-blur-sm border border-gray-700 hover:border-muted-coral rounded-xl transition-all duration-300 hover:scale-102"
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="bg-golden-yellow text-soft-black px-4 py-2 rounded-lg text-sm font-semibold ml-4">
                        SELECT
                      </div>
                    </div>
          ...
          {currentStep === 3 && selectedService && (
            <div className="animate-fade-in">
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-warm-beige mb-2">Complete Your Booking</h2>
                  <p className="text-muted-coral font-medium">
              ...
              {/* Service Summary */}
              <div className="card mb-8 bg-gradient-to-br from-muted-coral/10 to-golden-yellow/10 border-2 border-muted-coral border-opacity-30">
                <h3 className="text-lg font-semibold text-warm-beige mb-4">Service Summary</h3>
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                  <div>
                    <p className="text-gray-400 text-sm">Service</p>
                    <p className="text-warm-beige font-medium">{getCurrentService()?.name}</p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">Duration</p>
                    <p className="text-warm-beige font-medium">{getCurrentService()?.duration}</p>
                  </div>
                  <div>
              ...
              <div className="card">
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full btn-primary text-lg py-4 shadow-2xl"
                  >
      ...
      <div className="text-center py-8 border-t border-gray-800">
        ...
        <p className="text-warm-beige font-semibold">Eminence Hair Co. Booking System</p>
      </div>
    </div>
  );
};
