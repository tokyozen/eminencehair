  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-16 h-16 bg-gradient-to-r from-muted-coral to-burnt-orange rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center group ${
          isOpen ? 'hidden' : 'block'
        }`}
      >
        <MessageCircle className="w-8 h-8 text-white group-hover:scale-110 transition-transform duration-300" />
        <div className="absolute -top-2 -right-2 w-6 h-6 bg-golden-yellow rounded-full flex items-center justify-center">
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-96 h-[600px] bg-soft-black bg-opacity-95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-700 flex flex-col overflow-hidden animate-fade-in">
          {/* Header */}
          <div className="bg-gradient-to-r from-muted-coral to-golden-yellow p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                <Bot className="w-6 h-6 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-white">Hair Assistant</h3>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="mt-2 space-y-1">
                      {message.quickReplies.map((reply, index) => (
                        <button
                          ...
                          className="block w-full text-left text-xs px-3 py-2 bg-gray-700 bg-opacity-50 hover:bg-muted-coral hover:bg-opacity-20 text-gray-300 hover:text-warm-beige rounded-lg transition-colors duration-200"
                        >
                          {reply}
                        </button>
                      ))}
            ...
            {isTyping && (
              <div className="flex justify-start">
                <div className="bg-gray-800 bg-opacity-70 p-3 rounded-2xl">
          ...
          <div className="p-4 border-t border-gray-700">
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-800 bg-opacity-50 border border-gray-600 rounded-lg text-warm-beige placeholder-gray-400 focus:border-muted-coral focus:ring-1 focus:ring-muted-coral outline-none text-sm"
              />
              <button
                onClick={handleSendMessage}
                disabled={!inputValue.trim()}
                className="w-10 h-10 bg-gradient-to-r from-muted-coral to-burnt-orange rounded-lg flex items-center justify-center hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="flex space-x-2 mt-2">
              <button
                ...
                className="flex items-center space-x-1 px-3 py-1 bg-golden-yellow bg-opacity-20 text-golden-yellow rounded-full text-xs hover:bg-opacity-30 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center space-x-1 px-3 py-1 bg-muted-coral bg-opacity-20 text-muted-coral rounded-full text-xs hover:bg-opacity-30 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center space-x-1 px-3 py-1 bg-gray-600 bg-opacity-20 text-gray-300 rounded-full text-xs hover:bg-opacity-30 transition-colors"
              >
